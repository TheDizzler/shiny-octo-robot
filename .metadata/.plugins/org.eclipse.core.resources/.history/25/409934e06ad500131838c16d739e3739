	...
	public void onCreate(Bundle savedInstanceState) {
		...
		connect.setOnClickListener(new OnClickListener() {
			...
			@Override public void onClick(View v) {
				...
				new ConnectToServer(nvp, is, status).execute("http://qdap.ca/connectionTest.php");
			}
		});
	}
...
class ConnectToServer extends AsyncTask<String, Integer, String> {
	...
	public ConnectToServer(ArrayList<NameValuePair> nvp, InputStream is, TextView status) {
