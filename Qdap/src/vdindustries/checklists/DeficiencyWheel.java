...
public class DeficiencyWheel extends ActionBarActivity {
	...
	//	if(trade_def==""){
		private String specificItem[] = new String[] { "", "Drywall", "Tub/Showerbase", "Towel bar", "Glass Door",
				"Slider Door", "Pocket Door", "Shower Niche", "Bench", "Door", "Closet", "Exterior_Cladding", "Canopy",
				"Railing", "Shear-Wall", "Electrical Panel", "Comm_Box", "Vanity", "Cabinet", "Desk Space" };
	...
	private class ItemAdapter extends AbstractWheelTextAdapter {
		...
		private String itemList[] = new String[] { "", "Backing", "Joist", "Plywood", "Wall", "Wing Wall", "Stud",
				"Plate", "Dimensions", "Rough-Opening", "Poly-Liner", "Header", "Hold-Down", "Anchor", "Jamb",
				"Cripple" };
	...
	private class VerbAdapter extends AbstractWheelTextAdapter {
		...
		private String verb[] = new String[] { "", "Missing", "Crowned", "Bowed", "Split", "Incorrect", "Not-Plumb",
				"Not-Square", "Not-Level", "Not-Installed", "Not-Aligned", "Not-Secured", "Off", "Undersized",
				"Oversized", "Reduce", "Enlarge", "Box-Out", "Replace", "Proud", "Extend", "Relocate", "Subtract",
				"Add", "Center", "To Be" };
