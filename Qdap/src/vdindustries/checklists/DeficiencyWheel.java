...
public class DeficiencyWheel extends ActionBarActivity {
	...
	String			id, object_str, item_str, verb_str, direction_str,
					location_str, trade_def, room_def, floor_def;
	int				x, y;
	...
	class SpecificItemAdapter extends AbstractWheelTextAdapter {
		...
		private String	specificItem[]	= new String[]
										{ "", "Drywall", "Tub", "Showerbase", "Towel bar",
												...
												"Ext. Cladding", "Canopy", "Railing",
												"Shear-Wall", "Electrical Panel", "Comm. Box",
