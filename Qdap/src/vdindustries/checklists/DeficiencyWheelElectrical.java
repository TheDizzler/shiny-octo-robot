 ...
 */
public class DeficiencyWheelElectrical extends ActionBarActivity {
	...
	class SpecificItemAdapter extends AbstractWheelTextAdapter {
		...
		private String specificItem[] = new String[] { "", "Breaker Panel", "Multi-Media Box", "Comm. Box",
				"Thermostat", "Switch", "Plug", "Fixture", "Baseboard Heater", "Conduit", "Lumex Wire", "BX Wire",
				"Low Voltage Wire", "Telephone Wire", "CATV Wire", "Port Conduit" };
	...
	class ItemAdapter extends AbstractWheelTextAdapter {
		...
		private String itemList[] = new String[] { "", "Backing", "Location", "Height", "Ceiling Light", "Wall Mount",
				"Track", "Pot Light", "Puck Light", "Strip Light", "Ceiling Fan", "Booster Fan", "Microwave", "Fridge",
				"Hood Fan", "Oven", "Dishwasher", "GFI", "Transformer", "Fire Alarm", "Buzzer", "Speaker",
				"Burgular Alarm", "Handicap Button", "In-Floor Heating", "240 Volt", "120V" };
	...
	class VerbAdapter extends AbstractWheelTextAdapter {
		...
		private String verb[] = new String[] { "", "Missing", "Incorrect", "Not-Plumb", "Not-Level", "Not-Installed",
				"Not-Aligned", "Not-Secured", "Not Centered", "Undersized", "Oversized", "Replace", "Proud", "Extend",
				"Relocate", "Add", "Remove", "To Be" };
