...
/**
 * Fragment lifecycle: onAttach() onCreate() onCreateView() onActivityCreated()
 * - Activity and fragment instance have been created as well as thier view
 * hierarchy. At this point, view can be accessed with the findViewById()
 * method. onResume() onPause() onStop()
 * 
 * @author T-Dawg
 */
public class PlanFragment extends Fragment {
	...
	public void loadDeficiencies(String tradeSelected) {
		...
		// getActivity().findViewById(R.id.plan_image);
