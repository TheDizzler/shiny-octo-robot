...
public class ReportItemAdapter extends ArrayAdapter<ReportItem> {
	...
	public ReportItemAdapter(Context context, int layoutResourceId, List<ReportItem> data) {
		...
		if (row == null) {
			...
			holder.reportCheck.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
					...
					DeficiencyParser.setCompletionStatus(rItem.def.roomNo, rItem.def.trade, rItem.reportID, isChecked);
