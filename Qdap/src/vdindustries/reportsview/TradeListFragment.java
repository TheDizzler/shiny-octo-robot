...
/**
 * A list fragment representing a list of Trades. This fragment also supports
...
public class TradeListFragment extends ListFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setListAdapter(new ArrayAdapter<TradeContent.TradeItem>(getActivity(),
				android.R.layout.simple_list_item_activated_1, android.R.id.text1, TradeContent.ITEMS));
	}
	 ...
	 * // activities will be persistent through the application. The calls from
	 * the // DeficiencyParser still need to be made in order to write any
	 * changes to // the XML data file
	 */
