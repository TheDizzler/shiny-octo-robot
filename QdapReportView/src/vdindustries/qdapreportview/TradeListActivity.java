 ...
 * {@link TradeListFragment} and the item details
 * (if present) is a {@link TradeDetailFragment}.
 * <p>
 * This activity also implements the required
 * {@link TradeListFragment.Callbacks} interface
 * to listen for item selections.
 */
public class TradeListActivity extends FragmentActivity
        implements TradeListFragment.Callbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.trade_detail_container) != null) {
            ...
            ((TradeListFragment) getSupportFragmentManager()
                    .findFragmentById(R.id.trade_list))
    ...
    /**
     * Callback method from {@link TradeListFragment.Callbacks}
