 ...
 * currently being viewed in a {@link TradeDetailFragment}.
 * <p>
...
public class TradeListFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setListAdapter(new ArrayAdapter<TradeContent.Trade>(
                getActivity(),
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        mCallbacks.onItemSelected(TradeContent.trades.get(position).id);
    }
